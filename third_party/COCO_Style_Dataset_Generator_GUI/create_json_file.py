...
def run(image_dir, class_file, file_type, file_path):
    print('?')
    args = {
        'image_dir' : image_dir,
        'file_path' : file_path,
    ...
    import IPython
    IPython.embed()
    #for f in sorted(img_paths): # I fix this code
    ...
    for i, c in enumerate(classes): 
        categories.append({"supercategory": "","id": i+1, "name": c}) # i=0 is for backgorund

    data = {'images':images, 'annotations':anns, 'categories':categories, 'classes': classes}
